              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="text"
                      className={`pl-10 w-full px-4 py-2 bg-white text-black placeholder-gray border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.name ? 'border-red-500' : 'border-gray'} !text-black`}
                       name="name"
                      value={formData.name}
                ...
                {/* Password Field */}
                <div className="mb-4">
                  <label className="block mb-1">Password (6 or more characters)</label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 flex items-center pl-3">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 text-gray-400">
                ...
                <div className="mt-4 pb-4 text-center border-b border-gray-200">
                  ...
                  <div className="flex justify-center items-center">
                    <a href="#" className="flex items-center px-4 py-2 border shadow-sm rounded-md bg-white hover:bg-gray-50">
