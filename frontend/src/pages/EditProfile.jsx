...
export default function ProfileEdit() {
  ...
  const handleSaveProfile = () => {
    ...
    toast.success(" You profile information saved successfully!");
  };
  ...
  const handleIconClick = (platform) => {
    if (!activePlatforms.includes(platform)) {
      ...
      toast.info(`${platform.charAt(0).toUpperCase() + platform.slice(1)} added`);
    }
  };
  ...
  const handleRemove = (platform) => {
    ...
    toast.info(`${platform.charAt(0).toUpperCase() + platform.slice(1)} removed`);
  };
    ...
    <Case>
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 py-10 px-4">
        ...
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-8">
          {/* Left Column - About You and Skills & Social Media */}
                ...
                <div>
                  ...
                  {showInput ? (
                    <div className="flex items-center space-x-2">
                      ...
                      />
                      <Button size="sm" onClick={handleAddSkill} className="bg-blue-600 hover:bg-blue-700">
                        Add
                      </Button>
                    </div>
                  ) : (
                    ...
                    {socialPlatforms.map((platform) => (
                      <button
                        ...
                        className={`p-2 rounded-full hover:bg-gray-100 ${platform.color} ${
                          activePlatforms.includes(platform.name) ? 'ring-2 ring-blue-500 bg-blue-50' : ''
                        } transition-all`}
                      >
                        {platform.icon}
                      </button>
                  ...
                  <div className="space-y-3">
                    {activePlatforms.map((platform) => (
                      <div key={platform} className="flex items-center gap-2 bg-white p-2 rounded-lg border border-gray-100">
                        <div className={`p-2 rounded-full ${socialPlatforms.find(p => p.name === platform)?.color} bg-gray-50`}>
