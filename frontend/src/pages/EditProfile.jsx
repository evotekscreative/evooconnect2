...
import { Facebook, Twitter, Linkedin, Github, Instagram, X, User, Bookmark, Link2, Upload, MapPin, Calendar, Mail, Phone, Building, AlignLeft } from "lucide-react";
...
const socialPlatforms = [
  ...
  { name: "Instagram", platform: "instagram", icon: <Instagram />, color: "text-pink-500" },
  { name: "LinkedIn", platform: "linkedin", icon: <Linkedin />, color: "text-blue-700" },
  { name: "GitHub", platform: "github", icon: <Github />, color: "text-gray-800" },
];
            ...
            <Card className="shadow-lg border-0 overflow-hidden">
              <CardHeader className="bg-white border-b border-gray-100">
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="text-lg font-semibold text-gray-800">About You</CardTitle>
                </div>
              ...
              <CardContent className="pt-6 px-6 pb-6 space-y-5">
                <div className="flex flex-col items-center">
                  ...
                  <div className="flex space-x-2 mt-5">
                    <Button variant="outline" size="sm" onClick={() => fileInputRef.current.click()} className="flex items-center gap-1 border-gray-300 hover:bg-gray-50">
                      <Upload className="w-4 h-4" /> Upload Photo
                    </Button>
                    {profileImage && (
                      <Button variant="outline" size="sm" onClick={handleRemoveImage} className="flex items-center gap-1 border-red-200 hover:bg-red-50 text-red-500">
            ...
            <Card className="shadow-lg border-0 overflow-hidden">
              <CardHeader className="bg-white border-b border-gray-100">
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="text-lg font-semibold text-gray-800">Skills & Socials</CardTitle>
                </div>
                <CardDescription className="text-gray-500">Add your skills and social media links</CardDescription>
              </CardHeader>
              <CardContent className="pt-6 px-6 pb-6 space-y-5">
                <div>
                  <label className="text-sm font-medium mb-2 block text-gray-700">Skills</label>
                  <div className="flex flex-wrap gap-2 mb-3">
                    {skills.map((skill, idx) => (
                      <div key={idx} className="flex items-center bg-blue-50 text-blue-700 px-3 py-1 rounded-full text-sm border border-blue-100 hover:bg-blue-100 transition-colors">
                        {skill}
                        <button onClick={() => handleRemoveSkill(idx)} className="ml-1 text-blue-500 hover:text-blue-700">
                          <X className="w-4 h-4" />
                        </button>
                      </div>
                    ))}
                ...
                <div>
                  <label className="text-sm font-medium mb-2 block text-gray-700">Social Profiles</label>
                  ...
                  <div className="space-y-3">
                    {activePlatforms.map((platform) => {
                      ...
                      return (
                        <div key={platform} className="flex items-center gap-2 bg-white p-2 rounded-lg border border-gray-100">
                          <div className={`p-2 rounded-full ${platformInfo?.color || 'text-gray-500'} bg-gray-50`}>
                            {platformInfo?.icon || <User className="w-4 h-4" />}
                          </div>
                          <Input
                            placeholder={`${platformInfo?.name || platform} username`}
              ...
              <CardContent className="pt-6 px-6 pb-6">
                <div className="bg-white p-6 rounded-lg border border-gray-100 shadow-sm mb-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                      <label className="text-sm font-medium block mb-2 text-gray-700">Full Name</label>
                      <Input
                        className="w-full border-gray-200 focus:ring-blue-500"
                        value={fullName}
                    ...
                    <div>
                      <label className="text-sm font-medium block mb-2 text-gray-700">Username</label>
                      <Input
                    ...
                    <div>
                      <label className="text-sm font-medium block mb-2 text-gray-700">Headline</label>
                      <Input
                        className="w-full border-gray-200 focus:ring-blue-500"
                        value={headline}
                    ...
                    <div>
                      <label className="text-sm font-medium block mb-2 text-gray-700">Birthdate</label>
                ...
                <div className="bg-white p-6 rounded-lg border border-gray-100 shadow-sm mb-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                      <label className="text-sm font-medium block mb-2 text-gray-700">Gender</label>
                      <select
                    ...
                    <div>
                      <label className="text-sm font-medium block mb-2 text-gray-700">Email address</label>
                      <div className="relative">
                    ...
                    <div>
                      <label className="text-sm font-medium block mb-2 text-gray-700">Phone number</label>
                      <div className="relative">
                ...
                <div className="bg-white p-6 rounded-lg border border-gray-100 shadow-sm">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                      <label className="text-sm font-medium block mb-2 text-gray-700">Organization</label>
                      <div className="relative">
                    ...
                    <div className="md:col-span-2">
                      <label className="text-sm font-medium block mb-2 text-gray-700">Website</label>
                      <div className="relative">
