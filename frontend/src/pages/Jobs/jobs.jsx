...
export default function Jobs() {
  ...
  const [activeTab, setActiveTab] = useState(searchParams.get("tab") || "job");
  ...
  useEffect(() => {
    ...
    if (tabParam && (tabParam === "job" || tabParam === "company")) {
          ...
          <Card className="shadow-md rounded-xl bg-white">
            <CardContent className="p-4 text-center">
              <h2 className="font-bold text-md mb-1">
                Grow Your Business with EVOConnect
              </h2>
              <p className="text-sm text-gray-600 mb-4">
                Expand your team with top talent today!
              </p>
