...
// components
import IndexDropdown from "../../../components/Admin/Dropdowns/IndexDropdown.jsx";
      ...
      <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
        ...
        >
          ...
          <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
            ...
            <li className="flex items-center">
              <button
                className="bg-blue-500 text-white active:bg-blue-600 text-xs font-bold uppercase px-4 py-2 rounded shadow hover:shadow-lg outline-none focus:outline-none lg:mr-1 lg:mb-0 ml-3 mb-3 transition-all duration-150"
                type="button"
              >
