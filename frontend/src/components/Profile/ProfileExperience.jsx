...
export default function ProfileExperience({
  ...
  // State untuk setiap experience yang sedang di-expand
    ...
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      {experiences?.length > 0 ? (
        <div className="mt-6 space-y-8">
          {experiences.map((exp) => {
            const isLong = exp.caption && exp.caption.length > 500;
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {exp.caption && (
                      <div>
                        ...
                        {isLong && isExpanded && (
                          <button
                            className="text-blue-500 text-xs mt-1 font-bold hover:underline"
                            onClick={() => handleSeeLess(exp.id)}
                          >
                            See less
                          </button>
                        )}
